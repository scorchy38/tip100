...
class CaseExplorerEntryPointUI extends StatefulWidget {
  const CaseExplorerEntryPointUI({Key? key}) : super(key: key);

  @override
  State<CaseExplorerEntryPointUI> createState() =>
      CaseExplorerEntryPointUIState();
}

class CaseExplorerEntryPointUIState extends State<CaseExplorerEntryPointUI> {
  int _currentPage = 0;
