...
class CauseListFilters extends StatefulWidget {
  const CauseListFilters({Key? key}) : super(key: key);

  @override
  _CauseListFiltersState createState() => _CauseListFiltersState();
}

class _CauseListFiltersState extends State<CauseListFilters> {
  bool active = false;
  ...
  TextEditingController benchController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(
        builder: (context) {
          List<String>? bench = ['By Bench'];
          benchController.text = 'By Bench';
          context.watch<CauseListFiltersBloc>().state.bench?.forEach((element) {
            bench.add(element);
          });
              ...
              Padding(
                ...
                child: GridView(
                  ...
                  children: [
                    ...
                    //   ),
                    // ),
                    AppDropdown('By Bench', bench, benchController, 'By Bench'),
                    AppDropdown('By Court', courts, courtController, 'By Court')
                  ],
                ),
              ),
              const SizedBox(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          ...
                          context
                              .read<CauseListPDFBloc>()
                              .add(CauseListPDFGetInitialCauses());
                        },
                        child: Padding(
                        ...
                        builder: (context) {
                          ...
                          return InkWell(
                            onTap: () async {
                              context
                                  .read<CauseListFreeTextBloc>()
                                  .add(CauseListFreeTextRefreshing());
                              context
                                  .read<CauseListPDFBloc>()
                                  .add(CauseListPDFRefreshing());
                              setState(() {
                                courtMaps.forEach((element) {
                              ...
                              context
                                  .read<CauseListFreeTextBloc>()
                                  .add(CauseListFreeTextImplementingFilters());
                              context
                                  .read<CauseListPDFBloc>()
                                  .add(CauseListPDFImplementingFilters());

                              context.read<CauseListPDFBloc>().add(
                                  CauseListPDFGetFilteredResults(
                                      title: titleController.text,
                                      bench: benchController.text,
                              ...
                              context
                                  .read<CauseListPDFBloc>()
                                  .add(CauseListPDFFiltersImplemented());
                              context
                                  .read<CauseListFreeTextBloc>()
                                  .add(CauseListFreeTextFiltersImplemented());
