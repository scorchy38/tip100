        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              SmallButton(
                  onTap: (){
                    showModalBottomSheet(shape:     RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)), context: context, builder:(context) => AddLinkSheet());
                  },

                  buttonColor: AppColors.primary, buttonIcon: AppIcons.link),
              SizedBox(
                width: 10,
              ),
               IconButtonWithText( onTap: (){
                 showModalBottomSheet(shape:     RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)), context: context, builder:(context) => AddDocSheet());
