...
class ProductWiseChart extends StatefulWidget {
  const ProductWiseChart({Key? key}) : super(key: key);

  @override
  _ProductWiseChartState createState() => _ProductWiseChartState();
}

class _ProductWiseChartState extends State<ProductWiseChart> {
