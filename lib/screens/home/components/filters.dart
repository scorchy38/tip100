            ...
            child: Padding(
              ...
              child: GridView(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisSpacing: 10),
                children: [
                  selections('Past 30 Days', 1, context),
                  selections('Past 6 Months', 2, context),
                  selections('Past 1 Year', 3, context),
                  selections('This FY', 4, context),
                  selections('All Time', 5, context),
                ],
              ),
            ),
          ),
