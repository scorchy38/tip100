...
class AllCasesDocStorageFilters extends StatefulWidget {
  const AllCasesDocStorageFilters({Key? key}) : super(key: key);

  @override
  _AllCasesDocStorageFiltersState createState() =>
      _AllCasesDocStorageFiltersState();
}

class _AllCasesDocStorageFiltersState extends State<AllCasesDocStorageFilters> {
  bool active = false;
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Container(
                height: 45,
                child: AppTextField(false, titleController, 'By Title', 1)),
          ),
          Spacer(),
          Container(
