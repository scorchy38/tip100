...
class JudgementsEntryPointUI extends StatefulWidget {
  const JudgementsEntryPointUI({Key? key}) : super(key: key);

  @override
  State<JudgementsEntryPointUI> createState() => JudgementsEntryPointUIState();
}

class JudgementsEntryPointUIState extends State<JudgementsEntryPointUI> {
  int _currentPage = 0;
