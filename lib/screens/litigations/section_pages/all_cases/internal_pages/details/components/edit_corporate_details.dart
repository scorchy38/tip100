...
class EditCorporateDetails extends StatefulWidget {
  const EditCorporateDetails({Key? key}) : super(key: key);

  @override
  _EditCorporateDetailsState createState() => _EditCorporateDetailsState();
}

class _EditCorporateDetailsState extends State<EditCorporateDetails> {
