...
class LegalAreasCard extends StatefulWidget {
  ...
  @override
  State<LegalAreasCard> createState() => LegalAreasCardState();
}

class LegalAreasCardState extends State<LegalAreasCard> {
  List<Widget> legalAreas = [];
  List<String> legalAreasIds = [];
  @override
  void initState() {
    context
        ...
        .legalArea!
        .forEach((element) {
      legalAreasIds.add(element!);
      legalAreas.add(SizedBox(
        height: 10,
      ));
      legalAreas.add(InkWell(
        onTap: () async {
          final SharedPreferences _prefs =
              await SharedPreferences.getInstance();
          await legalAreasIds.remove(element);
          // var headers = {
          ...
          // };
          // print('{"linked_cases":${legalAreasIds.toString()}}');
          // var data = '{"linked_cases":${legalAreasIds.toString()}}';
          //
          // var url = Uri.parse(
